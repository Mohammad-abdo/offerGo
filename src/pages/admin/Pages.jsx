    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">{t('manageWebsitePagesAndContent', language)}</p>
        </div>
        <button
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {filteredPages.length === 0 ? (
              ...
              filteredPages.map((page) => (
                <tr key={page.id} className="hover:bg-gradient-to-r hover:from-orange-50/50 hover:to-transparent transition-colors duration-150">
                  <td className="px-6 py-4">
                    <div className="flex items-center">
                      <FiFileText className="mr-2 text-orange-600" size={18} />
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-md"
              placeholder={t('autoGeneratedFromTitle', language)}
            />
          </div>
